...
namespace Unity.BossRoom.Infrastructure
{
    ...
    public class NetworkObjectPool : NetworkBehaviour
    {
        ...
        Dictionary<GameObject, int> inSceneObjectsCount = new Dictionary<GameObject, int>();
        ...
        public int GetInSceneCount(GameObject prefab) => inSceneObjectsCount[prefab];

        public int GetMaxPoolCount(GameObject prefab)
        {
            foreach (var configObject in PooledPrefabsList)
            {
                if (configObject.Prefab == prefab)
                    return configObject.PrewarmCount;
            }
            return 0;
        }
        ...
        public NetworkObject GetNetworkObject(GameObject prefab, Vector3 position, Quaternion rotation)
        {
            ...
            // Add in scene obj count
            inSceneObjectsCount[prefab]++;
    ...
    class PooledPrefabInstanceHandler : INetworkPrefabInstanceHandler
    {
        ...
        {
            //Debug.Log("Destroy " +  networkObject.name);
